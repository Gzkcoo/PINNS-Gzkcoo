...
Exact_solution = griddata(xy_data, exact_solution.flatten(), (xm, ym), method='cubic')
Pred_solution = griddata(xy_data, pred_solution.flatten(), (xm, ym), method='cubic')

fig_1 = plt.figure(1, figsize=(18, 5))
plt.subplot(1, 3, 1)
plt.pcolor(xm, ym, Exact_solution, cmap='jet')
plt.colorbar()
plt.xlabel(r'$x$')
plt.ylabel(r'$y$')
plt.title('Exact $u(x)$')
...
plt.subplot(1, 3, 2)
plt.pcolor(xm, ym, Pred_solution, cmap='jet')
plt.colorbar()
plt.xlabel(r'$x$')
plt.ylabel(r'$y$')
...
plt.subplot(1, 3, 3)
plt.pcolor(xm, ym, np.abs(Exact_solution - Pred_solution), cmap='jet')
plt.colorbar()
plt.xlabel(r'$x$')
plt.ylabel(r'$y$')
